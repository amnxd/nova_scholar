...
export default function SignupPage() {
    ...
    const handleSignup = async (e) => {
        ...
        if (selectedRole === "student" && !email.endsWith("@bbdu.ac.in")) {
            setErrorMsg("Students must use a @bbdu.ac.in email address.");
            return;
        }
                ...
                <form onSubmit={handleSignup} className="space-y-5">
                    ...
                    <div>
                        ...
                        {selectedRole === "student" && (
                            <p className="mt-2 text-xs text-amber-600 dark:text-amber-400">
                                ⚠ Students must use their @bbdu.ac.in email
                            </p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder={selectedRole === "student" ? "yourname@bbd.ac.in" : "you@example.com"}
                            required
